...
class _UpdateUserProfileState extends State<UpdateUserProfile> {
  ...
  Widget build(BuildContext context) {
    ...
    //     text: userController.userProfile.value?.data?.email);
    TextEditingController _phoneController = TextEditingController(
        text: userController.userProfile.value?.data?.phone);
    TextEditingController _genderController = TextEditingController(
        text: userController.userProfile.value?.data?.gender ?? '');
    TextEditingController _aboutController = TextEditingController(
        text: userController.userProfile.value?.data?.about ?? '');
                  ...
                  children: [
                    CircleAvatar(
                      ...
                      backgroundImage:  NetworkImage(userController
                          .userProfile.value!.data!.profilePhotoUrl!)
                    ...
                    if (_profilePic == null &&
                        userController.userProfile.value!.data!.profilePhotoUrl!
                            .isEmpty)
              ...
              ElevatedButton(
                ...
                onPressed: () async {
                  ...
                  await userController.updateUserProfile(
                    ...
                    counrtyId: selectedCountry.toString()
                  );
